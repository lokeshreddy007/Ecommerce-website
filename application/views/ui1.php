...
<body>
    ...
    <!-- <div class="Back"> -->
        <!-- <INPUT TYPE="button" style="text-align: center" type="button" class="btn btn-success" VALUE="Back" onClick="history.go(-1);"> -->
         <button onclick="window.location.href='<?php echo base_url();?>Managementcontrol/ui2'" style="text-align: center;" type="button" >Next</button>
  ...
  <div class="row">
      <form class="form-horizontal" name="myForm" onsubmit="return validateForm()" action="<?php echo base_url();?>Managementcontrol/b" method="post">
      <center> <font color="red"> <?php echo $this -> session->flashdata("status"); ?></font></center>
    <div class="col-sm-10"><br>
    
    <div class="form-group">
        <label class="control-label col-sm-4" for="email"> N*:</label>
        <div class="col-sm-8">
            
            <input type="text"   class="form-control" id="n"   oninput="phoneValidation()" onkeypress="if(this.value.length==10) return false" min="0" placeholder="Enter name" name="a" required value="<?php echo $name ?> ">
      </div>
    </div>

    <div class="form-group">
        <label class="control-label col-sm-4" for="email"> u*:</label>
        <div class="col-sm-8">
            
            <input type="text"   class="form-control" id="n"   oninput="phoneValidation()" onkeypress="if(this.value.length==10) return false" min="0" placeholder="Enter name" name="b" required value="<?php echo $name ?> ">
      </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            ...
            <input type="text"   class="form-control" id="n"   oninput="phoneValidation()" onkeypress="if(this.value.length==10) return false" min="0" placeholder="Enter name" name="c" required value="<?php echo $name ?> ">
      </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            ...
            <input type="text"   class="form-control" id="n"   oninput="phoneValidation()" onkeypress="if(this.value.length==10) return false" min="0" placeholder="Enter name" name="d" required value="<?php echo $name ?> ">
      </div>
    </div>

    <div class="form-group">
        <label class="control-label col-sm-4" for="email"> im*:</label>
        <div class="col-sm-8">
            
            <input type="text"   class="form-control" id="n"   oninput="phoneValidation()" onkeypress="if(this.value.length==10) return false" min="0" placeholder="Enter name" name="e" required value="<?php echo $name ?> ">
      </div>
    </div>
