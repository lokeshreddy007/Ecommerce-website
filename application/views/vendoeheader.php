...
?>
<div class="topnav"> 
  <a class="active" href="<?php echo base_url();?>Managementcontrol/Vendorhome">Home</a>
   ...
   <a class="active" href="#"><?php echo $vendorname;?></a>
  ...
  <div class="topnav-right">
    ...
    <div class="dropdown-content">
      <a href="#"><?php echo $vendorname;?></a>
     
      <a href="<?php echo base_url();?>Managementcontrol/Profile?id=<?php echo $vendorname; ?>">Profile</a>
      <a href="<?php echo base_url();?>Managementcontrol/showcart?id=<?php echo $vendorid; ?>">Cart</a>  
