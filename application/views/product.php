...
<form class="form-horizontal" name="myForm"  action="<?php echo base_url();?>Managementcontrol/insertcart" method="post">
...
?>
 <?php foreach($userdata as $user){ ?>
                    <?php if($user->a == $name && $user->b == $usersurname && $user->c == $emailsess  ){?>  
                  <input type="hidden" value="<?php echo $user->c; ?>" name="usermail" />
                <input type="hidden" value="<?php echo $user->a; ?>" name="username" />
                <input type="hidden" value="<?php echo $user->iduf;?>" name="userid" />
                 <input type="hidden" value="<?php echo $user->g;?>" name="phonenum" />
                 <input type="hidden" value="<?php echo $user->i;?>" name="pincode" />
 ...
 <?php } ?>
               ...
               <span id="big-image" class="img" quickbeam="image" style="background-image: url('<?php echo base_url().$projItem->productimg; ?>')" data-src="'<?php echo base_url().$projItem->productimg; ?>'"></span>
 <?php } ?>
 <?php } ?>
                ...
                <div class="swipe-wrap">
                    <?php foreach($sliderlist as $projItem){ ?>
<?php if($projItem->productid == $id ){?>
    <div style="background-image: url('<?php echo base_url().$projItem->productimg; ?>')"></div>
...
<?php if($projItem->productid == $id ){?>
    ...
    <h1 itemprop="name">Product Name:<?php echo $projItem->productname; ?></h1>
 ...
 <?php } ?>
            ...
            <?php } ?>
              ...
              <label for="form_follow_up_date">From Date*</label>
              <input type="data" id="datepicker" class="form-control" value="<?php echo $dat ?>" style="background-color:#5bc0de;width: 50%;" placeholder="Enter date" name="fromdata" >

              <label for="form_follow_up_date">To Date*</label>
              <input type="data" id="datepicker1" class="form-control" value="<?php echo $dat ?>" style="background-color:#5bc0de;width: 50%;" placeholder="Enter date" name="todata" >
              <script>
$(function() {
              ...
              <form id="AddToCartForm">
                ...
                <div class="btn-and-quantity-wrap">
                  <div class="btn-and-quantity">
                    ...
                    </span> </center>  <button class="button" type="submit " id="AddToCartText">Add to Cart</button></span> </center>
                      <!-- <center><span  class="button" type="button" onclick="location.href='<?php echo base_url();?>Managementcontrol/viewcart?id=<?php echo $projItem->productid; ?>'" id="AddToCartText">Add to Cart</span> </center> -->
<style>
  .button {
    border: none;
    outline: 0;
