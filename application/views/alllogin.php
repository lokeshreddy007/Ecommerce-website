...
#footer {
   ...
   background:#6cf;
    ...
    <body>
        <div id="header">
            <h2><center>admin login</font></center></h2>
        </div>
        <div id="body">
            <div id="container"><br>
               <form action="<?php echo base_url(); ?>Managementcontrol/loginCheckEmployee" method="post">
           ...
           <font color="red"> <i><?php echo $this -> session->flashdata("managerlogin"); ?></i></font>
                    ...
                    <div class="form-group" >
                        ...
                        <input type="text" class="form-control" id="email" placeholder="Username/EmailAddress" name="mail" required>
                    </div>
                    <div class="form-group">
